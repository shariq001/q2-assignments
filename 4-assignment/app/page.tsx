...
const Home = () => {
  return (
    <div className='xl:px-[150px] sm:px-[20px] xl:min-w-[1440px] sm:min-w-[375px]'>
      ...
      {/* Arrow */}
      <div className='py-[100px] xl:block sm:hidden'>
      ...
      <div className='flex xl:flex-row xl:justify-between xl:py-[100px] border-black border-b-[3px] sm:flex-col sm:justify-start sm:gap-[30px] sm:py-[50px] sm:items-center xl:items-start'>
        ...
        {/* Right */}
        <div className='bg-[#606060] h-[364.68px] xl:w-[640px] sm:min-w-[343px] sm:max-[400px]'></div>
      ...
      <div className='flex xl:flex-row xl:justify-between xl:py-[100px] border-black border-b-[3px] sm:flex-col sm:justify-start sm:gap-[30px] sm:py-[50px] sm:items-center xl:items-start'>
        ...
        {/* Left */}
        <div className='xl:max-w-[500px] flex flex-col gap-5 inter sm:min-[343px] sm:max-[400px]'>
