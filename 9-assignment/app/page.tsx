...
const Home = () => {
  return (
    <div className='xl:min-w-[1440px] lg:min-w-[1024px] md:min-w-[768px] sm:min-w-[320px]'>
      {/* Section 1 */}
      <div className='bg-cyan-50 xl:p-[100px] sm:px-[10px] sm:py-[80px] flex md:flex-row sm:flex-col justify-between sm:justify-center sm:gap-[50px] items-center '>
        {/* Left */}
        <div className='flex flex-col xl:w-[651px] gap-[20px] sm:w-[300px] lg:w-[450px]'>
        ...
        {/* Right */}
        <div className='xl:w-[470px] sm:w-[300px] xl:h-[390px] sm:h-[300px] bg-[#457b9d] rounded-[40px] shadow-md shadow-gray-500 relative lg:w-[400px] lg:h-[400px]'>
          <Image src='/images/My project-1 (1) 2.png' width={405} height={424.76} className='absolute   sm:w-[343px] sm:h-[300px] sm:top-[-10px] xl:w-[405px] xl:h-[424.76px] xl:top-[-34px] xl:left-[50px] lg:w-[400px] lg:h-[400px]' alt='My Pic'/>
        </div>
      </div>

      {/* Section 2 */}

      <div className='xl:p-[100px] sm:px-[10px] sm:py-[80px] flex md:flex-row sm:flex-col  justify-between gap-[50px] items-center'>
        {/* Left */}
        <div className='xl:w-[500px] xl:h-[500px] sm:w-[300px] sm:h-[300px]'>
          <Image src='/images/Code typing-amico 1.png' width={500} height={500} alt='Person coding on computer' className='xl:w-[500px] xl:h-[500px] sm:w-[300px] sm:h-[300px]'/>
        </div>

        {/* Right */}
        <div className='xl:w-[564px] flex flex-col gap-[20px] sm:w-full md:w-[350px] lg:w-[500px]'>
      ...
      <div className='bg-cyan-50 xl:p-[100px] sm:px-[10px] sm:py-[80px] flex flex-col gap-[20px] items-center'>
        <h2 className='xl:text-[24px] sm:text-[20px] text-[#457B9D] font-bold '>Skills</h2>
        <h1 className='xl:text-[48px] sm:text-[28px] font-[700] sm:text-center'>What I am capable of?</h1>
        <ul className='flex md:flex-row sm:flex-col justify-center gap-[30px] items-center'>
      ...
      <div className='lg:p-[100px] sm:px-[10px] sm:py-[80px] flex flex-col gap-[20px] items-center'>
      ...
      <div className='bg-cyan-50 xl:p-[100px] sm:px-[16px] sm:py-[80px] flex flex-col gap-[0px] items-start'>
        <h2 className='lg:text-[24px] sm:text-[20px] text-[#457B9D] font-bold'>Contacts</h2>
        <h1 className='lg:text-[48px] sm:text-[30px] font-[700]'>Get in touch</h1>
        <p className='lg:text-[20px]'>rizfanher@gmail.com</p>
