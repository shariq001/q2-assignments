...
const Home = () => {
  return (
    <div>
      {/* Section 1 */}
      <div className='bg-cyan-50 p-[100px] flex justify-center gap-[30px] items-center'>
        {/* Left */}
        <div className='flex flex-col w-[651px] gap-[20px]'>
          <h2 className='text-[24px] text-[#457B9D]'>Hi Everyone, I am</h2>
          <h1 className='text-[48px] font-[700]'>Rizfan Herlaya</h1>
          <p className='text-[20px] leading-[25.2px]'>Lorem ipsum dolor sit amet consectetur. Vitae maecenas pellentesque tellus tempus purus integer nisi cras fermentum.</p>
        ...
        {/* Right */}
        <div className='w-[470px] h-[390px] bg-[#457b9d] rounded-[40px] shadow-md shadow-gray-500 relative'>
          <Image src='/images/My project-1 (1) 2.png' width={405} height={424.76} className='absolute top-[-124px] left-[50px]' alt='My Pic'/>
        </div>
      </div>

      {/* Section 2 */}

      <div className='p-[100px] flex justify-center gap-[50px] items-center'>
        {/* Left */}
        <div className='w-[500px] h-[500px] '>
          <Image src='/images/Code typing-amico 1.png' width={500} height={500} alt='Person coding on computer' />
        </div>

        {/* Right */}
        <div className='w-[564px] flex flex-col gap-[20px]'>
          <h2 className='text-[24px] text-[#457B9D] font-bold'>About</h2>
          <h1 className='text-[48px] font-[700]'>About Me?</h1>
          <p className='text-[20px] leading-[25.2px] text-[#455A64]'>Lorem ipsum dolor sit amet consectetur. Iaculis diam augue a adipiscing non aliquet. Leo semper lacus fringilla consectetur cras ac ullamcorper ut. Risus nunc diam accumsan feugiat. Tristique diam consectetur aliquam vitae suspendisse vel leo. Nec quisque senectus laoreet id pulvinar id vulputate. Montes consectetur diam non aliquam nunc maecenas non. Molestie pretium amet id dictum vitae nam vel sit. Rhoncus massa velit ut amet massa morbi eget.</p>
        </div>
      </div>

      {/* Section 3 */}

      <div className='bg-cyan-50 p-[100px] flex flex-col gap-[20px] items-center'>
        <h2 className='text-[24px] text-[#457B9D] font-bold'>Skills</h2>
        <h1 className='text-[48px] font-[700]'>What I am capable of?</h1>
      ...
      <div className='py-[100px] px-[180px] flex flex-col gap-[20px] items-center'>
        <h2 className='text-[24px] text-[#457B9D] font-bold'>Projects</h2>
        <h1 className='text-[48px] font-[700]'>What I have made?</h1>
      ...
      {/* Section 6 */}
      <div className='bg-cyan-50 p-[100px] flex flex-col gap-[0px] items-start'>
        <h2 className='text-[24px] text-[#457B9D] font-bold'>Contacts</h2>
        <h1 className='text-[48px] font-[700]'>Get in touch</h1>
        <p className='text-[20px]'>rizfanher@gmail.com</p>
