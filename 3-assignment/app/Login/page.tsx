  ...
  return (
    <div className='flex justify-center items-center bg-gradient-to-r from-[#050A24] via-[#2D55FB] to-[#050A24]'>
        <div className='w-[540px] h-[456px] bg-white m-[119.5px] flex flex-col justify-center items-center rounded-[20px]'>
            ...
            <input type="email" placeholder='Enter your email' className='w-[70%]  border-[#d0d5dd] border-[1px] py-[8px] px-[10px] rounded-[10px] mb-[10px]'/>

            <p className='text-[16px] mb-[10px]'>Password</p>
            <input type="password" placeholder='Enter your password' className='w-[70%]  border-[#d0d5dd] border-[1px] py-[8px] px-[10px] rounded-[10px]'/>
            ...
            <div className='flex gap-5'>
                ...
                <a href="/Signup" className='text-[#1570EF] text-[16px]'>Sign up</a>
            </div>
        </div>
    </div>
  )
